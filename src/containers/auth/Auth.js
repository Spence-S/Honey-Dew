      ...
      <form className="form-horizontal">
        <fieldset>
          <legend className="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            {this.state.showSignIn ? 'Login' : 'Sign Up'}
          </legend>
          <div className="form-group">
            <div className="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
              {!this.state.showSignIn
                ...
                : <div>
                    Login with email and password. Facebook Login is coming
                    soon!
                  </div>}
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-8">
              <button
                ...
                name="button1"
                className={
                  this.state.showSignIn ? 'btn btn-info' : 'btn btn-link'
                }
                onClick={
                  this.state.showSignIn ? this.sendFormData : this.togglePage
                }
              >
                Sign In{' '}
              </button>
              <button
                ...
                name="button2"
                className={
                  this.state.showSignIn ? 'btn btn-link' : 'btn btn-info'
                }
                onClick={
                  this.state.showSignIn ? this.togglePage : this.sendFormData
                }
              >
                Sign-Up
              </button>
